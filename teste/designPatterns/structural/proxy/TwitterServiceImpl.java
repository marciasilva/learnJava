...
public class TwitterServiceImpl implements TwitterService {
	...
	private static final String TWITTER_ACESS_TOKEN_SECRET = "";
	...
	public String getTimeline(String screenName) {
		...
		cb.setDebugEnabled(true).setOAuthConsumerKey(TWITTER_CONSUMER_KEY).setOAuthConsumerSecret(TWITTER_SECRET_KEY)
				.setOAuthAccessTokenSecret(TWITTER_ACESS_TOKEN_SECRET).setOAuthAccessToken(TWITTER_ACCESS_TOKEN);
	...
	public void postToTimeline(String screenName, String message) {
		System.out.println("don't trink and post, that is not cool!");
	}
}
